/* 🟢 main.js — 2025-11-03R1m (responsive 16:9 players; fix tiny video) */
(function () {
  'use strict';
  window.AppVersion = '2025-11-03R1m';
  ...
  const playInlineVideo = (container, playable) => {
    ...
    if (playable.type === 'video') {
      ...
      f.style.width = '100%';
      // 🔴 Removed fixed 315px height; use responsive aspect ratio
