...
(function(){
  ...
  async function renderHome(){
    ...
    if(snap){
      ...
      wireCardClicks(feed); placeSentinelAfterLastCard(); attachObserver();
      ...
      requestAnimationFrame(()=>{requestAnimationFrame(()=>{window.scrollTo(0,y); RESTORING=false; kick();});});
      return;
    }
