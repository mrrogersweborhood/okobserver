/* OkObserver · home.v263.js · v2.6.5
   - 4-column grid (uses .ok-grid from index.html)
   - Clickable image/title → #/post/{id}
   - Infinite scroll with IntersectionObserver
   - Filters out “cartoon/cartoons” posts (categories/tags)
   - No external utils; safe URL builder & JSON fetch included
*/
...
export default async function renderHome(app) {
  ...
  // keep scroll position when entering/leaving detail
