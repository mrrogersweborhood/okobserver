// app.js — OkObserver (v1.33.9-lite)
// Minimal, reliable build to get you unstuck: grid + detail, author/date, tags,
// Cartoon exclusion, safe links, "Load more" button.
const APP_VERSION = "v1.33.9-lite";
  ...
  function renderHome({ search="" } = {}) {
    ...
    async function load() {
      ...
      try {
        ...
        showError(`Failed to load posts: ${e.message||e}`); loadMore.textContent = "Retry"; loadMore.disabled = false;
