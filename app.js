// app.js — OkObserver v1.54 (adds normalizeFirstParagraph fix)
...
(() => {
  ...
  // ...[the rest of your existing functions stay unchanged]...

  // Inside renderPost(), immediately after fixAlign(wrapper):
